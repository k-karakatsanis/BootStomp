...
if __name__ == "__main__":
    ...
    boot_img = '../Evaluation/LK/unpatched/lk_unpatched';
    func_info_file = '../Evaluation/info_files/info.functions.lk_unpatched.angr'
    ...
    try:
        project = angr.Project(boot_img, load_options={
    ...
    for entry_point in entry_points:
        my_function = cfg.functions.get(entry_point)
        basic_blocks = my_function.blocks
